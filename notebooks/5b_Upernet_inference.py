...
# %%
# SET IMAGE FOR TEST
month= "apr" ## Set this suffix for the test image folder tiles
...
# %%
# Load checkpoint 
chkp = SCRATCH_DIR /"run_logs_UPerNet/vit_test/version_4/checkpoints/epoch=9-val_iou=0.17052706.ckpt"  # Change path to checkpoint

# %%
# Load the model
model= ViTForSeg.load_from_checkpoint(chkp)
model.eval()
...
if __name__ == "__main__":
    ...
    # Save to a text file
    results_file_path = Path(IMAGERY_DIR / month / "UPerNet_results_summary.txt")
